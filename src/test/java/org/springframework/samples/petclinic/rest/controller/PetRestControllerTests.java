...
class PetRestControllerTests {
    ...
    void initPets() {
        ...
        pets.add(pet.id(3)
            ...
            .weight(java.math.BigDecimal.valueOf(15.75))
            .type(petType));
        ...
        pets.add(pet.id(4)
            .name("Jewel")
            .birthDate(LocalDate.now())
            .weight(java.math.BigDecimal.valueOf(8.50))
            .type(petType));
    }
    ...
    void testUpdatePetSuccess() throws Exception {
        ...
        newPet.setWeight(java.math.BigDecimal.valueOf(16.25));
        ...
        this.mockMvc.perform(get("/api/pets/3")
            ...
            .andExpected(jsonPath("$.name").value("Rosy I"))
            .andExpected(jsonPath("$.weight").value(16.25));
