...
INSERT INTO pets (name, birth_date, type_id, owner_id, weight) SELECT 'Rosy', '2001-04-17', 2, 3, 15.4 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=3);
...
INSERT INTO pets (name, birth_date, type_id, owner_id, weight) SELECT 'George', '2000-01-20', 4, 5, 1.8 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=6);
...
INSERT INTO pets (name, birth_date, type_id, owner_id, weight) SELECT 'Mulligan', '1997-02-24', 2, 8, 22.5 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=10);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight) SELECT 'Freddy', '2000-03-09', 5, 9, 0.9 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=11);
...
INSERT INTO pets (name, birth_date, type_id, owner_id, weight) SELECT 'Sly', '2002-06-08', 1, 10, 3.6 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=13);
