...
INSERT INTO pets (name, birth_date, type_id, owner_id, weight) SELECT 'Rosy', '2001-04-17', 2, 3, 15.5 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=3);
...
INSERT INTO pets (name, birth_date, type_id, owner_id, weight) SELECT 'Mulligan', '1997-02-24', 2, 8, 22.7 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=10);
...
INSERT INTO pets (name, birth_date, type_id, owner_id, weight) SELECT 'Lucky', '2000-06-24', 2, 10, 18.9 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=12);
