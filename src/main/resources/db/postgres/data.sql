...
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Leo', '2000-09-07', 5.2, 1, 1 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=1);
...
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Iggy', '2000-11-30', 0.5, 3, 4 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=5);
...
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Samantha', '1995-09-04', 8.3, 1, 6 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=7);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Max', '1995-09-04', 12.1, 1, 6 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=8);
...
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Mulligan', '1997-02-24', 25.0, 2, 8 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=10);
...
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Lucky', '2000-06-24', 18.5, 2, 10 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=12);
