...
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Leo', '2000-09-07', 1, 4.2, 1 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=1);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Basil', '2002-08-06', 6, 0.8, 2 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=2);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Rosy', '2001-04-17', 2, 12.5, 3 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=3);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Jewel', '2000-03-07', 2, 15.3, 3 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=4);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Iggy', '2000-11-30', 3, 2.1, 4 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=5);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'George', '2000-01-20', 4, 3.7, 5 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=6);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Samantha', '1995-09-04', 1, 3.8, 6 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=7);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Max', '1995-09-04', 1, 4.1, 6 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=8);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Lucky', '1999-08-06', 5, 0.6, 7 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=9);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Mulligan', '1997-02-24', 2, 22.8, 8 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=10);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Freddy', '2000-03-09', 5, 0.7, 9 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=11);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Lucky', '2000-06-24', 2, 18.2, 10 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=12);
INSERT INTO pets (name, birth_date, type_id, weight, owner_id) SELECT 'Sly', '2002-06-08', 1, 3.9, 10 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=13);
