...
INSERT INTO pets (name, birth_date, type_id, owner_id, weight) SELECT 'Leo', '2000-09-07', 1, 1, 12.5 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=1);
...
INSERT INTO pets (name, birth_date, type_id, owner_id, weight) SELECT 'Rosy', '2001-04-17', 2, 3, 7.2 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=3);
