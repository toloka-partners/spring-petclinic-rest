...
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Leo', '2000-09-07', 4.2, 1, 1 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=1);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Basil', '2002-08-06', 0.3, 6, 2 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=2);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Rosy', '2001-04-17', 15.5, 2, 3 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=3);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Jewel', '2000-03-07', 12.8, 2, 3 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=4);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Iggy', '2000-11-30', 2.1, 3, 4 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=5);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'George', '2000-01-20', 0.8, 4, 5 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=6);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Samantha', '1995-09-04', 3.9, 1, 6 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=7);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Max', '1995-09-04', 4.1, 1, 6 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=8);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Lucky', '1999-08-06', 0.15, 5, 7 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=9);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Mulligan', '1997-02-24', 18.3, 2, 8 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=10);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Freddy', '2000-03-09', 0.12, 5, 9 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=11);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Lucky', '2000-06-24', 14.2, 2, 10 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=12);
INSERT INTO pets (name, birth_date, weight, type_id, owner_id) SELECT 'Sly', '2002-06-08', 3.7, 1, 10 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=13);
